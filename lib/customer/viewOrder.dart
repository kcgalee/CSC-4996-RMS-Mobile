                          ...
                          children: [
                            Expanded(
                                child: SizedBox(
                                    ...
                                    child: ListView.builder(
                                        itemCount: widget
                                            .createOrderInfo.itemID.length,
                                        itemBuilder: (context, index) {
                                          return OrderTile(
                                            imgURL: widget
                                                .createOrderInfo.imgURL[index],
                                            taskName:
                                                "${widget.createOrderInfo.itemName[index]}"
                                                " x ${widget.createOrderInfo.count[index]}"
                                                '\nComment: ${widget.createOrderInfo.orderComments[index]}',
                                            price: widget
                                                .createOrderInfo.price[index],
                                            createOrderInfo:
                                            ...
                                            onPressedEdit: (BuildContext) {
                                              ...
                                              int currentCount = widget
                                                  .createOrderInfo.count[index];
                                              int? count = 0;
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (widget.createOrderInfo.imgURL[index] ==
                                                                          ...
                                                                          SizedBox(
                                                                            ...
                                                                            width:
                                                                                350,
                                                                            child:
                                                                                Image.network(widget.createOrderInfo.imgURL[index]),
                                                                          ),
                                                                        const SizedBox(
                                                                            height:
                                                                                20),
                                                                        ...
                                                                        const SizedBox(
                                                                            height:
                                                                                20),
                                                                        CustomTextForm(
                                                                            hintText: widget.createOrderInfo.orderComments[
                                                                                index],
                                                                            controller:
                                                                ...
                                                                TextButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (orderCommentsController
                                                                            ...
                                                                            .toString() ==
                                                                        '') {
                                                                      widget.createOrderInfo.updateOrder(
                                                                          index,
                                                                          count!,
                                      ...
                                      CustomMainButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            //===================================
                                                ...
                                                .createOrderInfo.itemID.isEmpty) {
                                              showDialog<void>(
                                                context: context,
                                                barrierDismissible: false,
                                                // user must tap button!
                                                  ...
                                                  return AlertDialog(
                                                    ...
                                                    content:
                                                      ...
                                                      child: ListBody(
                                                        children: const <Widget>[
                                                          Text(
                                                              'Bill requested, cannot place anymore orders.'),
                                                        ],
                                                      ),
                                                    ),
                                                    actions: <Widget>[
