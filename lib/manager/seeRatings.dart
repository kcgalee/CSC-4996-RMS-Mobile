...
class SeeRatings extends StatefulWidget {
  ...
  SeeRatings({Key? key, required this.restaurantID, required this.restName})
      : super(key: key);
              ...
              if (!snapshot.hasData || snapshot.data?.docs.length == 0) {
                return Column(children: [
                  ...
                  Expanded(
                      child: Center(
                    child: Text(
                        "You currently have no reviews for ${widget.restName}."),
                  ))
                ]);
              } else {
                            ...
                            return ManagerTile(
                              taskName: 'Rating: ' +
                                  (snapshot.data?.docs[index]['rating']
                                      ...
                                      ''),
                              subTitle: 'Name: ' +
                                  (snapshot.data?.docs[index]['custName'] ??
                                      '') +
                                  '\nDate: ' +
                                  (convertTime(
